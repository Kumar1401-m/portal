...
export const ENGINES: Engine[] = [
  ...
  { key: "strategist", label: "Content Strategist", purpose: "The month's pillars, topics and posting plan", module: "—", needs: ["post_insights"], built: false },
  { key: "scripts", label: "Script Generator", purpose: "Hook, body and CTA in English, Telugu or Tenglish", module: "—", needs: [], built: false },
  { key: "ideas", label: "Content Ideas", purpose: "New ideas from what already worked", module: "—", needs: ["post_insights"], built: false },
  ...
  { key: "thumbnails", label: "Thumbnail Assistant", purpose: "Title, expression and layout concepts", module: "—", needs: [], built: false },
  { key: "seo", label: "SEO Assistant", purpose: "Local keywords, titles and content clusters", module: "—", needs: [], built: false },
